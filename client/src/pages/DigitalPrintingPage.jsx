                        ...
                        <form className="space-y-5 relative z-10" onSubmit={e => e.preventDefault()}>
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative group/input">
                                    ...
                                    <select
                                        className={`w-full bg-slate-50 dark:bg-slate-800/50 border-slate-100 dark:border-slate-700 rounded-2xl py-3 pl-10 pr-4 text-xs font-bold focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all appearance-none cursor-pointer ${errors.matId ? 'border-rose-500 ring-2 ring-rose-500/10' : ''}`}
                                        value={matId}
                                        onChange={e => {
                                    ...
                                    >
                                        ...
                                        {materials.map(m => (
                                            <option key={m.id} value={m.id}>{m.name} — {fmt(m.sellPrice)}/{m.unit} (Stok: {m.stok})</option>
                                        ))}
                                    </select>
                                </div>
                                {errors.matId && <p className="text-[10px] text-rose-500 font-bold mt-1 ml-1 uppercase">{errors.matId}</p>}
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1.5">
                                    ...
                                    <input
                                        className={`w-full bg-slate-50 dark:bg-slate-800/50 border-slate-100 dark:border-slate-700 rounded-2xl py-3 px-4 text-sm font-bold focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all ${errors.lebar ? 'border-rose-500 ring-2 ring-rose-500/10' : ''}`}
                                        placeholder="0.0"
                                        type="number"
                                        step="0.1"
                                        value={lebar}
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <input
                                        className={`w-full bg-slate-50 dark:bg-slate-800/50 border-slate-100 dark:border-slate-700 rounded-2xl py-3 px-4 text-sm font-bold focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all ${errors.panjang ? 'border-rose-500 ring-2 ring-rose-500/10' : ''}`}
                                        placeholder="0.0"
                                        type="number"
                                        step="0.1"
                                        value={panjang}
                            ...
                            <div className="p-5 bg-blue-600 rounded-3xl shadow-xl shadow-blue-200 dark:shadow-none relative overflow-hidden group/price">
                                <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-0 group-hover/price:opacity-100 transition-opacity"></div>
                                <p className="text-[9px] font-black text-blue-100 uppercase tracking-[0.2em] mb-1">Estimasi Total Biaya</p>
                                <div className="flex justify-between items-end">
                                    <h4 className="text-2xl font-black text-white italic tracking-tighter">{fmt(totalEstimasi)}</h4>
                            ...
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Catatan Desainer</label>
                                <textarea
                                    className="w-full bg-slate-50 dark:bg-slate-800/50 border-slate-100 dark:border-slate-700 rounded-2xl p-4 text-xs font-medium focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all resize-none placeholder:text-slate-400/50"
                                    rows="2"
                            ...
                            <button
                                className="w-full py-4 bg-slate-900 dark:bg-blue-600 text-white rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl shadow-slate-200 dark:shadow-none hover:bg-black dark:hover:bg-blue-700 transition-all flex items-center justify-center gap-3 active:scale-[0.98]"
                                type="button"
